...
class SendEmail {
  ...
  async productMadeAvailable() {
    await this.send("productMadeAvailable", this.type);
  }

  async productExpired() {
    await this.send("productExpired", this.type);
  }

  async productRemoved() {
    await this.send("productRemoved", this.type);
  }

  async productAdded() {
    await this.send("productAdded", this.type);
  }
}
